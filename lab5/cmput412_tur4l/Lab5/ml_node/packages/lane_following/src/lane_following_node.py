...
import threading
import math
from kinetic_controller import KineticController
...
class LaneFollowNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.controller = KineticController()  # will handle wheel commands during turning
    ...
    def callback(self, msg):
        ...
        if max_idx != -1:
            ...
            pass  # self.proportional = None  # use te proportional value from last timestep
    ...
    def drive(self):
        if self.is_turning():  # TURNING
            ...
            if turn_idx == 0:
                self.controller.driveForDistance(.47)
                self.controller.adjustToTargetRotation(math.pi *.62)
                self.controller.driveForDistance(.37)
            elif turn_idx == 1:
